        ...
        <div className="flex flex-col justify-between items-center  md:min-h-[280px] py-5 px-3 w-full md:w-1/4 bg-gradient-to-b from-yellow-400 to-yellow-700 ">
          <div>
            ...
            <p className="text-center font-Rubik">
              Be patient, Relax. M/S Mitali International is here for you. We
              provide package solution for your business
            </p>
          </div>
          <button className="rounded-full bg-white text-black px-6 py-2 uppercase font-semibold font-Work">
            Contact Us Now
          </button>
        </div>
