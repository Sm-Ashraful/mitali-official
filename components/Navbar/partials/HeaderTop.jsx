...
const HeaderTop = () => {
  return (
    <div className="font-Allerta bg-gradient-to-r from-[#0479ae]  to-[#045c94] px-2 md:px-16 py-2 flex justify-between items-center">
      <div className="flex text-[12px]">
        <div className="flex text-white items-center gap-2">
          <span className="border p-2 text-[14px]  md:text-xl">
            <MdOutlineLocationOn />
          </span>
          <div className="">
            <p className="md:text-xl"> Location</p>
            <p className="text-[9px] md:text-[16px]">
    ...
    */}
      <div className="flex text-white border hover:border-black hover:bg-white hover:text-black bg-transparent px-2 md:px-6 py-2  items-center text-[12px] md:rounded overflow-hidden gap-2">
        ...
        <span className="hidden md:block">+123 4567 89</span>
      </div>
    </div>
  );
};
