...
const Branding = () => {
  return (
    <div
      ...
      className=" overflow-hidden -mt-5 w-full md:w-[50%] pt-5 md:pt-0 md:flex items-center h-[140px] bg-gradient-to-r from-[#045c94]  to-[#0479ae] absolute left-0 md:left-[25%] -bottom-[55px] md:-bottom-[35%] z-20 rounded-md"
    >
      <div
        style={{
          position: "absolute",
