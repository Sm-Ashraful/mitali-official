...
const Review = () => {
  return (
    <div className="pt-10 px-2 md:px-16 flex flex-col gap-3">
      <div className="flex flex-col md:flex-row gap-3 w-full">
        <div className="w-full md:w-[50%] border flex flex-col items-center pt-4">
          <div className="w-[50%]">
            ...
            >
              ...
              <SwiperSlide>
                <q className="text-[8pt] pb-2">
                  ...
                  their adaptability and willingness to collaborate with a
                  smaller yet rapidly expanding business like ours.
                </q>
                <p className="text-[8pt] text-red-500 text-end">
                  __ CEO of Mash Inc.
                </p>
      ...
      <div className="w-full max-w-[680px] mx-auto  gap-10 border-2 border-slate-400">
        <div className="flex justify-center items-center bg-[#013953] px-5 py-2 md:py-3 lg:py-4">
