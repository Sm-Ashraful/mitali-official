...
function Calendar() {
  ...
  return (
    <div className=" md:rounded w-full ">
      <div className="w-full rounded">
        <div className="flex items-center justify-between mb-2 bg-[#045c94] px-2 py-2">
          <div className="text-left font-bold text-xl text-white ">
            {`${activeMonthString} ${activeYear}`}
          </div>
          <div className="flex space-x-4">
            <button
              className="p-2 rounded  bg-white text-yellow-400"
              onClick={() => {
        ...
        <div className="-mx-2">
          <table className="w-full dark:text-white">
            <thead>
              <tr>
                <th className="py-2 px-2 md:px-3 text-red-500">Sun</th>
                <th className="py-2 px-2 md:px-3 ">Mon</th>
                <th className="py-2 px-2 md:px-3 ">Tue</th>
                <th className="py-2 px-2 md:px-3 ">Wed</th>
                <th className="py-2 px-2 md:px-3 ">Thu</th>
                <th className="py-2 px-2 md:px-3 ">Fri</th>
                <th className="py-2 px-2 md:px-3 text-red-500">Sat</th>
              </tr>
            </thead>
            <tbody>
              <tr>
